...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'project.create.create': { roles: ['owner', 'project-manager'], key: 'project', tenantPath: [], userPath: [] },
  'task.update.update': { roles: ['owner', 'project-manager'], key: 'task', tenantPath: [], userPath: [] },
  'issue.resolve.update': { roles: ['owner', 'project-manager'], key: 'issue', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'project-manager'];
