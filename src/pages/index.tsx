  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management System - Unleashing the Power of Efficient Time and Project Management. Harness the potential of our solution to optimize your workflow."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1506452819137-0422416856b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0aW1lJTIwbWFuYWdlbWVudHxlbnwwfHx8fDE2OTU4ODAwOTN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@ikukevk?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Kevin Ku`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management System - Unleashing the Power of Efficient Time and Project Management. Harness the potential of our solution to optimize your workflow.`}
            </Text>
            <Box
